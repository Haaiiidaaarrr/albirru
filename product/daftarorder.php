...
<html>
<head>
<title>Al-Birru Collection - Daftar Belanja</title>
<!-- for-mobile-apps -->
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						Rp<?php 				$ongkir = 10000;
												$ordid = $b['orderid'];
												$result1 = mysqli_query($conn,"SELECT SUM(qty*hargaafter)+$ongkir-$ongkir AS count FROM detailorder d, produk p where d.orderid='$ordid' and p.idproduk=d.idproduk order by d.idproduk ASC");
