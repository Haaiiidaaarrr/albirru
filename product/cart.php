...
<html>
<head>
<title>Al-Birru Collection - Keranjang Saya</title>
<!-- for-mobile-apps -->
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						?>
						<li> Terimakasih sudah berbelanja<!--Total (inc. 10k Ongkir)<i> - </i> <span>Rp<?php //echo number_format($subtotal) ?></span>--></li>
					</ul>
				</div>
